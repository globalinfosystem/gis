<script type='text/javascript' src='<?php echo base_url() ?>administrator/js/jquery.crypt.js'></script>
<style>
    *.unselectable {
...
<div class="sbox">
    ...
    <div class="sbox-content">
        <div class="text-center">
            <img src="<?php echo base_url(); ?>administrator/themes/<?php echo CNF_THEME;?>/img/logo.jpg" width="100" />
        </div>	
