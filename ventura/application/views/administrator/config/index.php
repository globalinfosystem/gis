  ...
  <div class="page-content row">
    ...
    <div class="page-header">
 	...
 	<div class="page-content-wrapper m-t">  		
		<div class="block-content">
			...
			<fieldset> 
				<legend><?php echo $this->lang->line('core.fr_frontendmetakey'); ?> </legend>
			  <div class="form-group">
		  ...
		  <fieldset> 
			  ...
			  <div class="form-group">
				<label for="ipt" class=" control-label col-md-4">Office Address</label>
				<div class="col-md-8">
					<textarea class="form-control input-sm" name="cnf_office_address"><?php echo  CNF_OFFICE_ADDRESS ;?></textarea>
				 </div> 
			  </div> 

			   <div class="form-group">
				<label  class=" control-label col-md-4">Copy Rights</label>
				<div class="col-md-8">
					<textarea class="form-control input-sm"  name="cnf_copy_rights"><?php echo CNF_COPY_RIGHTS ;?></textarea>
				 </div> 
			  </div>
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<textarea class="form-control input-sm"  name="cnf_company"><?php echo CNF_COMPANY ;?></textarea>
					</div> 
				</div>
	...
	<div class="col-sm-6">
		  ...
		  <fieldset> 
				<legend>Footer</legend>
			  <div class="form-group">
				<label for="ipt" class=" control-label col-md-4">Facebook URL</label>
				<div class="col-md-8">
					<textarea class="form-control input-sm" name="cnf_facebook_url"><?php echo  CNF_FACEBOOK_URL ;?></textarea>
				 </div> 
			  </div> 
			   ...
			   <div class="form-group">
				...
				<div class="col-md-8">
					<textarea class="form-control input-sm"  name="cnf_twitter_url"><?php echo CNF_TWITTER_URL ;?></textarea>
				 </div> 
			  </div>

				<div class="form-group">
					<label  class=" control-label col-md-4">You Tube URL</label>
					<div class="col-md-8">
						<textarea class="form-control input-sm"  name="cnf_youtube_url"><?php echo CNF_YOUTUBE_URL ;?></textarea>
					</div> 
				</div>
				
				<div class="form-group">
					<label  class=" control-label col-md-4">Email Sent</label>
					<div class="col-md-8">
						<textarea class="form-control input-sm"  name="cnf_email_sent"><?php echo CNF_EMAIL_SENT ;?></textarea>
					</div> 
				</div>
