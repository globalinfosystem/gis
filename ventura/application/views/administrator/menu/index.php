...
<div class="page-content row">
    ...
    <div class="page-content-wrapper m-t">  
        <ul class="nav nav-tabs" style="margin:10px 0;">
            ...
            <li <?php if ($active == 'otherlinks') echo 'class="active"' ?>><a href="<?php echo site_url('administrator/menu/index?pos=otherlinks'); ?>"><i class="icon-paragraph-justify2"></i><?php echo $this->lang->line('core.tab_otherlinks'); ?> </a></li>	
            <li <?php if ($active == 'programmes') echo 'class="active"' ?>><a href="<?php echo site_url('administrator/menu/index?pos=programmes'); ?>"><i class="icon-paragraph-justify2"></i><?php echo $this->lang->line('core.tab_programmes'); ?> </a></li>	
        </ul>  	
                                                        ...
                                                        <?php foreach ($menu2['childs'] as $menu3) : ?>
                                                            <li data-id="<?php echo $menu3['menu_id']; ?>" class="dd-item dd3-item">
                                                                ...
                                                                <?php if (count($menu3['childs']) > 0) : ?>
                                                                    <ol class="dd-list" style="">
                                                                        <?php foreach ($menu3['childs'] as $menu4) : ?>
                                                                            <li data-id="<?php echo $menu4['menu_id']; ?>" class="dd-item dd3-item">
                                                                                <div class="dd-handle dd3-handle"></div><div class="dd3-content"><?php echo $menu4['menu_name']; ?>
                                                                                    <span class="pull-right">
                                                                                        <a href="<?php echo site_url('administrator/menu/index/' . $menu4['menu_id'] . '?pos=' . $active); ?>"><i class="fa fa-cogs"></i></a>
                                                                                    </span>
                                                                                </div>
                                                                                <?php if (count($menu4['childs']) > 0) : ?>
                                                                                    <ol class="dd-list" style="">
                                                                                        <?php foreach ($menu4['childs'] as $menu5) : ?>
                                                                                            <li data-id="<?php echo $menu5['menu_id']; ?>" class="dd-item dd3-item">
                                                                                                <div class="dd-handle dd3-handle"></div><div class="dd3-content"><?php echo $menu5['menu_name']; ?>
                                                                                                    <span class="pull-right">
                                                                                                        <a href="<?php echo site_url('administrator/menu/index/' . $menu5['menu_id'] . '?pos=' . $active); ?>"><i class="fa fa-cogs"></i></a>
                                                                                                    </span>
                                                                                                </div>
                                                                                            </li>	
                                                                                        <?php endforeach; ?>
                ...
                <div class=" box">	
                    ...
                    <div class="form-group  " >
                        ...
                        <div class="col-md-8">
                            ...
                            <input type="radio" name="position"  value="otherlinks"  required
                                   <?php if ($row['position'] == 'otherlinks' || $this->input->get('pos') == 'otherlinks') echo 'checked="checked"'; ?>  /> Other Links
                            <input type="radio" name="position"  value="programmes"  required
                                   <?php if ($row['position'] == 'programmes' || $this->input->get('pos') == 'programmes') echo 'checked="checked"'; ?>  /> Programmes
                        </div> 
                    </div> 	 				
                    <div class="form-group  " >
