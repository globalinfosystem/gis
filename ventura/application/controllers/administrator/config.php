...
class Config extends SB_Controller {
    ...
    public function postSave() {
        ...
        $val .= "define('CNF_FACEBOOK_URL','" . $this->input->post('cnf_facebook_url', true) . "');\n";
        $val .= "define('CNF_TWITTER_URL','" . $this->input->post('cnf_twitter_url', true) . "');\n";
        $val .= "define('CNF_YOUTUBE_URL','" . $this->input->post('cnf_youtube_url', true) . "');\n";
        $val .= "define('CNF_EMAIL_SENT','" . $this->input->post('cnf_email_sent', true) . "');\n";
		
        $val .= "define('CNF_MULTILANG','" . ($this->input->post('cnf_multilang') == 1 ? '1' : '0') . "');\n";
        $val .= "define('CNF_OFFICE_ADDRESS','" . $this->input->post('cnf_office_address', true) . "');\n";
        $val .= "define('CNF_COPY_RIGHTS','" . $this->input->post('cnf_copy_rights', true) . "');\n";
        $val .= "define('CNF_COMPANY','" . $this->input->post('cnf_company', true) . "');\n";
        $val .= "?>";
