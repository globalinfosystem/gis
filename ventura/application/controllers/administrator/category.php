...
class Category extends SB_Controller 
{
	...
	function index() 
	{
		...
		$sort = (!is_null($this->input->get('sort', true)) ? $this->input->get('sort', true) : 'category_id'); 
		...
		$this->data['content'] = $this->load->view('administrator/category/index',$this->data, true );
	...
	function show( $id = null) 
	{
		...
		$this->data['id'] = $id;
		$this->data['content'] =  $this->load->view('administrator/category/view', $this->data ,true);	  
		$this->load->view('layouts/main',$this->data);
	}
	...
	function add( $id = null ) 
	{
		...
		$this->data['id'] = $id;
		$this->data['content'] = $this->load->view('administrator/category/form',$this->data, true );		
	  	$this->load->view('layouts/main', $this->data );
	...
	function save() {
		...
		if( $this->form_validation->run() )
		{
			...
			$ID = $this->model->insertRow($data , $this->input->get_post( 'category_id' , true ));
			// Input logs
			...
			{
				redirect( 'administrator/category/add/'.$ID,301);
			} else {
				redirect( 'administrator/category',301);
			}			
